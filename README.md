...
This repo therefore uses [these instructions](https://stackoverflow.com/a/14013645/329496) to deploy up to a github pages branch. Beware: GitHub wont let you upload huge JARs so its not really a valid approach except for experments. All opensource can get free maven repo hosting on maven central. Private projects can run their own artifact server there are a few good ones that are open source based. 
